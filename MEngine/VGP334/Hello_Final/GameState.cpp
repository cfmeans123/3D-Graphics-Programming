	...
	mStandardEffect.SetDirectionalLight(mDirectionalLight);
	{
		...
		mBikerAnimator.Initialize(mBikerID);
		{
			...
			mBikerEvent = AnimationBuilder()
				...
				.AddEventKey([&]() {mBikerAnimator.PlayAnimation(2, true); }, 8.0f)
	...
	}
	{
		...
		mGuyAnimator.Initialize(mGuyID);
		{
			...
			mGuyEvent = AnimationBuilder()
				...
				.AddEventKey([&]() {mGuyAnimator.PlayAnimation(2, true); }, 9.3f)
				.AddEventKey([&]() {mGuyAnimator.PlayAnimation(3, false); }, 12.6f)
				.AddRotationKey(Quaternion::CreateFromAxisAngle({ 0.0f, 1.0f, 0.0f }, -80.0f), 15.0f)
				.AddEventKey([&]() {mGuyAnimator.PlayAnimation(4, true); }, 15.1f)
